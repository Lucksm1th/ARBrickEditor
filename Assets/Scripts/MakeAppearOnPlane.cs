...
public class MakeAppearOnPlane : MonoBehaviour
{
    ...
    void Update()
    {
            ...
            if (m_RaycastManager.Raycast(touch.position, s_Hits, TrackableType.PlaneWithinPolygon))
        {
            ...
            Vector3 imagePosition = GetComponent<TrackImagesInfo>().imagePosition;
            ...
            m_SessionOrigin.MakeContentAppearAt(content, imagePosition, m_Rotation);

        }
    }

    //public void SetScale(Vector2 touchPosition)
    //{
    ...
    //        if (m_SessionOrigin.transform.localScale != Vector3.one * 50)
    //            m_SessionOrigin.transform.localScale = Vector3.one * 50;
    //    }
    //}
