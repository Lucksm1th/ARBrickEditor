...
namespace Unity.LEGO.Behaviours
{
    public class MinifigCollider : MonoBehaviour
    {
        ...
        void OnControllerColliderHit(ControllerColliderHit hit)
        {
            ...
            {
                GameFlowManager.Instance.PlaySound(2, 0.5f);
                GameFlowManager.Instance.ResetPlayer();
            }
        }
        ...
        private void OnTriggerEnter(Collider other)
        {
            ...
            {
                if (GameFlowManager.Instance.isPlacedAtSpawn)
                    GameFlowManager.Instance.CurrentRoom = other.gameObject.transform.parent.gameObject;
            }
        }
    }
}
