...
namespace Unity.LEGO.Minifig
{
    ...
    {
        public static MinifigController Instance;

        public FixedJoystick joystick;

        // Constants.
        const float stickyTime = 0.05f;
        const float stickyForce = 99.6f;
        ...
        public void SetEnableController(bool state)
        {
        ...
        protected virtual void Update()
        {
            ...
            if (startRotate)
            {
                if (rotationDelay > rotationTimer)
                {
                    rotationTimer = 0;
                    startRotate = false;
                }
                    ...
                    case InputType.Direct:
                        {
                            ...
                            var targetSpeed = right * /*Input.GetAxisRaw("Horizontal")*/joystick.Horizontal;
                            targetSpeed += forward * /*Input.GetAxisRaw("Vertical")*/joystick.Vertical;
